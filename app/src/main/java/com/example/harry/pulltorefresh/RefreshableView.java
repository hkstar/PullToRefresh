package com.example.harry.pulltorefresh;
...
public class RefreshableView extends LinearLayout implements View.OnTouchListener{
     ...
     * 头文件的布局文件
     */
    private MarginLayoutParams headerLayoutParams = null;
    /**
     * 下拉头的高度
     */
     ...
     * @param i
     */
    public void setOnRefreshListener(PullToRefreshListener listener, int i) {
        mListener = listener;
    }
    /**
